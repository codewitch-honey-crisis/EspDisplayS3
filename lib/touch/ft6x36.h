...
#define FT6X36_OPMODE_REG               0xBC
    ...
    /**
     * @brief  Get the touch screen X and Y positions values and number of touch points
     * @param  touch_data: pointer to X and Y positions and number of tocuh points
     * @retval true if successs
     */
    bool ft6x36_read_pos(touch_pos_t *touch_pos);

    /**
     * @brief  Read the FT6x36 gesture ID.
